...
## 6. Property-Based Formula Sanitization Guidance

- Property-based suites now gate formula authoring across schema and CLI surfaces; use the workflow below before submitting new packs or modifiers.
- Guidance complements `docs/property-based-formula-sanitization-design.md` and the CLI runbook in `docs/content-validation-cli-design.md`.
...
| Topic | Owner | Target Review | Tracking |
| --- | --- | --- | --- |
| Long-term maintenance of shared formula arbitraries | Content Pipeline Maintainers | Implementation Plan Phase 2 exit (2025-11-15) | `docs/property-based-formula-sanitization-design.md#13-open-questions` |
| Prestige-layer monotonicity requirements | Game Design Lead | Align with Prestige roadmap checkpoint (2025-12-01) | `docs/property-based-formula-sanitization-design.md#13-open-questions` |
