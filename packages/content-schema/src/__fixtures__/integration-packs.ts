...
/**
 * PRESTIGE LAYER: Pack with prestige layer but no manually-defined prestige count resource.
 * The prestige count resource should be auto-generated during normalization.
 */
export const prestigeLayerWithAutoGeneratedCountFixture = {
  metadata: {
