...
export function canonicalEncodeForHash(value) {
...
export async function hashViewModel(viewModel) {
    return sha256Hex(canonicalEncodeForHash(viewModel));
}
export async function hashRenderCommandBuffer(rcb) {
...
function normalizeNumbersForHash(value) {
    if (value === null) {
        return null;
    }
    switch (typeof value) {
