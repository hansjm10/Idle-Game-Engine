/**
 * Browser-safe entry point for the full `@idle-engine/core` API surface.
 *
 * This module is intentionally large and includes many low-level symbols that
 * are not considered stable public API.
 *
...
export {
  ...
  type RunCombinedReplayOptions,
  type RunCombinedReplayResult,
  ...
  type SimReplayFramesV2,
  type SimReplayHeaderV1,
  type SimReplayHeaderV2,
  type SimReplayRenderCommandBufferFrameV2,
  type SimReplaySchemaVersion,
  type SimReplaySimV1,
  type SimReplayV1,
  type SimReplayV2,
  type SimReplayViewModelFrameV2,
  type SimReplayWiringConfig,
  type VisualReplayMismatchSummary,
